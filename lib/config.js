...
module.exports = (function () {
  ...
  return {
    ...
    validate: function () {
      ...
      // As of Jingo 1.9, editor must be codemirror|editormd
      if (!_.isEqual('codemirror', config.features.editor)
        && !_.isEqual('editormd', config.features.editor)) {
          error = 'editor must be codemirror|editormd\n'
        return false
      }
